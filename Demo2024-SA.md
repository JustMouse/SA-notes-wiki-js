...
[Выполните базовую настройку всех устройств:](#1.-Выполните-базовую-настройку-всех-устройств:)
...
```
**Пример на HQ-R:**
![demo24-isp-nmtui.png](/demo24-isp-nmtui.png)
**Пример:**
HQ-R:
